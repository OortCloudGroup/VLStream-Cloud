...
-- 检查 user_roles 表字段
SELECT 'Checking user_roles table structure...' as status;
SELECT 
    COLUMN_NAME,
    DATA_TYPE,
    IS_NULLABLE,
...
-- 检查 user_permissions 表字段
SELECT 'Checking user_permissions table structure...' as status;
SELECT 
    COLUMN_NAME,
    DATA_TYPE,
    IS_NULLABLE,
...
-- 验证关键表的字段
SELECT 'user_roles table columns:' as info;
SHOW COLUMNS FROM user_roles;

SELECT 'user_permissions table columns:' as info;
