...
<template>
  <div class="app-container">
    <el-form ref="wvpMediaServerRef" :model="form" :rules="rules" label-width="100px">
      <el-row :gutter="20">
        <el-col :span="12">
...
<script setup name="AddMediaServer">
import {saveWvpMediaServer, checkMediaServer} from "../../../api/wvp/wvpMediaServer.js";
