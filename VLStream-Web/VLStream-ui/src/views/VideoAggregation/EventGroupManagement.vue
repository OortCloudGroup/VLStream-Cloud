              ...
              <template #default="{ data }">
                <div class="custom-tree-node flexRowAC">
                  ...
                  <div class="tree-node-actions flexRowAC" @click.stop>
                    <oort-svg-icon width="14" height="14" name="add" @click="openCreate(data)" />
                    <oort-svg-icon width="14" height="14" name="edit_icon" @click="openEdit(data)" />
                    <oort-svg-icon width="14" height="14" name="delete" color="red" @click="removeGroup(data)" />
                  </div>
                </div>
              </template>
            </el-tree>
