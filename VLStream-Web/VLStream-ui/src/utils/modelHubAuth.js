...
/**
 * Model Hub
 * 1. , appname + redirect_uri
 * 2. successfully after redirect_uri?accessToken=xxx
...
/**
 * need to ?query:
 * will ?access_token=xxx, redirect_uri already ? will
 * ?tab=user?access_token=xxx ( ), token Parse failed .
 */
...
/* * OortCloud current VLS , userinfo . */
...
/**
 * in Vue Router before OortCloud .
 * only Process startModelHubLogin in , VLStream
 * accessToken OortCloud Token.
 */
...
/* * only OortCloud , VLStream main will . */
