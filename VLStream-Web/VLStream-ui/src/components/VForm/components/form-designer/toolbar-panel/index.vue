  ...
  <div class="toolbar-container new_table">
    <div class="toolbar_opr_group">
      <div class="left-toolbar">
        <el-tooltip
          :content="i18nt('designer.toolbar.undoHint')"
          effect="light"
          placement="top"
        >
        ...
        <el-tooltip
          :content="i18nt('designer.toolbar.redoHint')"
          effect="light"
          placement="top"
        >
          <div class="new_table_svg_group">
        ...
        <el-tooltip
          :content="i18nt('designer.toolbar.pcLayout')"
          effect="light"
          placement="top"
        >
          <div class="new_table_svg_group">
        ...
        <el-tooltip
          :content="i18nt('designer.toolbar.padLayout')"
          effect="light"
          placement="top"
        >
          <div class="new_table_svg_group">
        ...
        <el-tooltip
          :content="i18nt('designer.toolbar.mobileLayout')"
          effect="light"
          placement="top"
        >
          <div class="new_table_svg_group">
      ...
      <div class="right-toolbar">
        ...
        <!-- <el-button link type="primary" @click="saveForm(1)">
            <svg-icon icon-class="el-document" />保存为组件
          </el-button>
          <el-button link type="primary" @click="saveForm(0)">
            <svg-icon icon-class="el-document" />保存为表单
          </el-button>
    ...
    <div v-if="showPreviewDialogFlag" v-drag="['.drag-dialog.el-dialog', '.drag-dialog .el-dialog__header']" class="">
      <el-dialog
      ...
      >
        ...
        <template #footer>
          <div class="dialog-footer">
            ...
            <el-button v-if="false" @click="testLoadForm">
              Test Load
            </el-button>
    ...
    <div v-if="showImportJsonDialogFlag" v-drag="['.drag-dialog.el-dialog', '.drag-dialog .el-dialog__header']" class="">
      <el-dialog
        ...
        :destroy-on-close="true"
      >
        <el-alert type="info" :title="i18nt('designer.hint.importJsonHint')" show-icon class="alert-padding" />
    ...
    <div v-if="showExportJsonDialogFlag" v-drag="['.drag-dialog.el-dialog', '.drag-dialog .el-dialog__header']" class="">
      <el-dialog
    ...
    <div v-if="showExportCodeDialogFlag" v-drag="['.drag-dialog.el-dialog', '.drag-dialog .el-dialog__header']" class="">
      <el-dialog
        ...
        :destroy-on-close="true"
      >
        <el-tabs v-model="activeCodeTab" type="border-card" class="no-box-shadow no-padding">
    ...
    <div v-if="showFormDataDialogFlag" v-drag="['.nested-drag-dialog.el-dialog', '.nested-drag-dialog .el-dialog__header']" class="">
      <el-dialog
    ...
    <div v-if="showExportSFCDialogFlag" v-drag="['.drag-dialog.el-dialog', '.drag-dialog .el-dialog__header']" class="">
      <el-dialog
        ...
        :destroy-on-close="true"
      >
        <el-tabs v-model="activeSFCTab" type="border-card" class="no-box-shadow no-padding">
...
import { ElTabs, ElButton, ElTree, ElDrawer,
  ElTabPane, ElDialog, ElAlert, ElMessageBox, ElDropdown, ElDropdownItem, ElTooltip } from 'element-plus'

export default {
  name: 'ToolbarPanel',
  components: {
    ElAlert,
    ElTabs, ElButton, ElTree, ElDrawer,
    ElTabPane, ElDialog,
    VFormRender,
    CodeEditor,
    ElDropdown, ElDropdownItem, ElTooltip
  },
  mixins: [i18n],
  ...
  methods: {
    ...
    saveAsFile(fileContent, defaultFileName) {
      ElMessageBox.prompt(this.i18nt('designer.hint.fileNameForSave'), this.i18nt('designer.hint.saveFileTitle'), {
