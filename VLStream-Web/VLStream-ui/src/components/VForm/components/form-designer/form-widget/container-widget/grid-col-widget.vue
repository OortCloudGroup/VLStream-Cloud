...
<template>
  ...
  >
    ...
    <div v-if="designer.selectedId === widget.id && widget.type === 'grid-col'" class="grid-col-action">
      <i
        :title="i18nt('designer.hint.selectParentWidget')"
        @click.stop="selectParentWidget(widget)"
      ><svg-icon icon-class="el-back" /></i>
      <i
    ...
    <div v-if="designer.selectedId === widget.id && widget.type === 'grid-col'" class="grid-col-handler">
