...
<template>
  <div class="container-wrapper" :class="[customClass]">
    ...
    <div v-if="designer.selectedId === widget.id && !widget.internal" class="container-action">
