...
<template>
  <div>
      ...
      <el-collapse v-model="formActiveCollapseNames" class="setting-collapse">
        <el-collapse-item name="1" :title="i18nt('designer.setting.basicSetting')">
          ...
          <el-form-item :label="i18nt('designer.setting.formModelName')">
            <el-input v-model="formConfig.modelName" type="text" />
          </el-form-item>
          <el-form-item :label="i18nt('designer.setting.formRefName')">
            <el-input v-model="formConfig.refName" type="text" />
          </el-form-item>
          <el-form-item :label="i18nt('designer.setting.formRulesName')">
            <el-input v-model="formConfig.rulesName" type="text" />
          </el-form-item>
        </el-collapse-item>
    ...
    <div v-if="showFormEventDialogFlag" v-drag="['.drag-dialog.el-dialog', '.drag-dialog .el-dialog__header']" class="">
      <el-dialog
    ...
    <div v-if="showEditFormCssDialogFlag" v-drag="['.drag-dialog.el-dialog', '.drag-dialog .el-dialog__header']" class="">
      <el-dialog
        ...
        :destroy-on-close="true"
      >
        <code-editor v-model="formCssCode" :mode="'css'" :readonly="false" />
        <template #footer>
          <div class="dialog-footer">
    ...
    <div v-if="showEditFunctionsDialogFlag" v-drag="['.drag-dialog.el-dialog', '.drag-dialog .el-dialog__header']" class="">
      <el-dialog
        ...
        :destroy-on-close="true"
      >
        <code-editor ref="gfEditor" v-model="functionsCode" :mode="'javascript'" :readonly="false" />
        <template #footer>
          <div class="dialog-footer">
...
import { ElFormItem, ElDialog, ElButton, ElCollapse, ElCollapseItem, ElInput, ElForm, ElRadio, ElRadioButton, ElRadioGroup, ElSelect, ElOption, ElAlert, ElDivider,
