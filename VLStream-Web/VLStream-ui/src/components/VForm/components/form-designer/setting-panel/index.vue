...
<template>
  <el-container class="panel-container">
          ...
          <template v-if="!!designer.selectedWidget && !designer.selectedWidget.category">
            ...
            >
              <el-collapse v-model="widgetActiveCollapseNames" class="setting-collapse">
                <el-collapse-item v-if="showCollapse(commonProps)" name="1" :title="i18nt('designer.setting.commonSetting')">
                ...
                <el-collapse-item v-if="showCollapse(advProps)" name="2" :title="i18nt('designer.setting.advancedSetting')">
                ...
                <el-collapse-item v-if="showEventCollapse() && showCollapse(eventProps)" name="3" :title="i18nt('designer.setting.eventSetting')">
    ...
    <div v-if="showWidgetEventDialogFlag" v-drag="['.drag-dialog.el-dialog', '.drag-dialog .el-dialog__header']" class="">
      <el-dialog
...
import { ElContainer, ElButton, ElDialog, ElTabPane, ElTabs,
  ElCollapse, ElCollapseItem, ElInput, ElScrollbar, ElAlert, ElForm } from 'element-plus'
