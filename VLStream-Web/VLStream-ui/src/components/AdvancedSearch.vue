...
const handleSearch = () => {
  emit('search', {
    ...
    ...searchForm.value,
    // selectedTagsConvert to tagName
  ...
  .search-container {
    ...
    .search-box {
      ...
      .search-input {
        flex: 1;
        height: 100%;
        margin-right: 81px; // to button and button null / empty (20px + 2px + 55px + 4px)
    ...
    .form-content {
      ...
      .form-row {
        ...
        .form-item {
          ...
          // TagSelector el-select also is 408px
          :deep(.tag-selector) {
            width: 408px !important;
