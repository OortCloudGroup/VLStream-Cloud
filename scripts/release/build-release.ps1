...
Copy-Item (Join-Path $Root "deploy/release/zlmediakit") (Join-Path $Package "zlmediakit") -Recurse
...
Copy-Item (Join-Path $Root "deploy/release/sql/init/20-create-wvp-database.sh") (Join-Path $Package "sql/init/20-create-wvp-database.sh")
