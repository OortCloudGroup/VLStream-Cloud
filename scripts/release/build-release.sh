...
cp "$MIGRATION/V1_1_3_007__vls_device_firmware.sql" "$PACKAGE/sql/upgrade/36-v1.1.3-007-vls-device-firmware.sql"
cp "$MIGRATION/V1_1_3_008__vls_device_firmware_ota.sql" "$PACKAGE/sql/upgrade/37-v1.1.3-008-vls-device-firmware-ota.sql"
cp "$MIGRATION/V1_2_0_001__gpu_training_scheduler_metadata.sql" "$PACKAGE/sql/upgrade/40-v1.2.0-001-gpu-training-scheduler-metadata.sql"
cp "$MIGRATION/V1_2_0_002__vls_rootfs_only_firmware.sql" "$PACKAGE/sql/upgrade/41-v1.2.0-002-vls-rootfs-only-firmware.sql"
cp "$MIGRATION/V1_2_0_003__multi_tenant_shadow_identity.sql" "$PACKAGE/sql/upgrade/42-v1.2.0-003-multi-tenant-shadow-identity.sql"
cp "$MIGRATION/V1_2_0_004__multi_tenant_event_report_outbox.sql" "$PACKAGE/sql/upgrade/43-v1.2.0-004-multi-tenant-event-report-outbox.sql"
