...
| 名称 | 用途 | 版本号 | 仓库地址 | 授权协议 |
| --- | --- | --- | --- | --- |
| VLStream Server（VLS） | 设备注册、用户绑定、事件、模型任务和平台 API | Maven `0.8.3`；Spring Boot `2.7.11`；发布镜像 `1.2.5` | [GitHub 仓库](https://github.com/OortCloudGroup/VLStream-Cloud) | [MIT](./LICENSE) |
