...
import com.ruoyi.vlstream.compat.smartjavaai.stream.ObbDetStreamDetectionListener;
import com.ruoyi.vlstream.compat.smartjavaai.stream.ObbDetStreamDetector;
...
/**
 * device (OBB) will : Load model , in snapshot event; and .
 */
@Slf4j
