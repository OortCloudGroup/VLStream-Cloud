...
public final class ObbDetStreamDetector implements AutoCloseable {
    ...
    private ObbDetStreamDetector(Builder builder) {
        ObbDetModel model = Objects.requireNonNull(builder.model, "detectorModel must not be null");
        ObbDetStreamDetectionListener listener = Objects.requireNonNull(builder.listener, "listener must not be null");
    ...
    public static final class Builder {
        ...
        public Builder detectorModel(ObbDetModel value) {
            model = value;
            return this;
        }

        public Builder listener(ObbDetStreamDetectionListener value) {
            listener = value;
            return this;
        }

        public ObbDetStreamDetector build() {
            return new ObbDetStreamDetector(this);
        }
    }
}
