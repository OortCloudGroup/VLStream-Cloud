...
create table sys_user (
  ...
  idcard            varchar(50)     not null                   comment '用户身份证',
...
CREATE TABLE `sys_job_level`  (
  ...
  `oort_level` int(0) NULL DEFAULT NULL COMMENT '职务等级（数字越小等级越高）',
  `oort_tcreate` bigint(0) NULL DEFAULT NULL COMMENT '创建时间',
  `oort_tupdate` bigint(0) NULL DEFAULT NULL COMMENT '修改时间',
  `oort_tdelete` int(0) NULL DEFAULT NULL COMMENT '是否删除 0否 1是',
...
-- ----------------------------
-- 一级菜单
insert into sys_menu values('1', '系统管理', '0', '1', 'system',   null, '', 1, 0, 'M', '1', '0', '', 'system',   'admin', sysdate(), '', null, '系统管理目录');
insert into sys_menu values('2', '系统监控', '0', '2', 'monitor',  null, '', 1, 0, 'M', '1', '0', '', 'monitor',  'admin', sysdate(), '', null, '系统监控目录');
...
insert into sys_dict_type values(12, '审批按钮', 'wf_approval_button',   '0', 'admin', sysdate(), '', null, '流程审批按钮');
...
insert into sys_dict_data values(34, 1,  '通过',   '0',   'wf_approval_button',   '',   'warning',  'Y', '0', 'admin', sysdate(), '', null, '流程审批通过');
insert into sys_dict_data values(35, 2,  '委派',   '1',   'wf_approval_button',   '',   'warning',  'Y', '0', 'admin', sysdate(), '', null, '流程审批委派');
insert into sys_dict_data values(36, 3,  '转办',   '2',   'wf_approval_button',   '',   'warning',  'Y', '0', 'admin', sysdate(), '', null, '流程审批转办');
insert into sys_dict_data values(37, 4,  '退回',   '3',   'wf_approval_button',   '',   'warning',  'Y', '0', 'admin', sysdate(), '', null, '流程审批退回');
insert into sys_dict_data values(38, 5,  '拒绝',   '4',   'wf_approval_button',   '',   'warning',  'Y', '0', 'admin', sysdate(), '', null, '流程审批拒绝');
...
) ENGINE = InnoDB AUTO_INCREMENT = 1782670758319403010 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '流程附件信息' ROW_FORMAT = Dynamic;



ALTER TABLE `sys_user`
MODIFY COLUMN `user_id` varchar(64) NOT NULL COMMENT '用户ID' FIRST;
...
ALTER TABLE `wf_copy`
MODIFY COLUMN `user_id` varchar(64) NULL DEFAULT NULL COMMENT '用户主键' AFTER `task_id`;

ALTER TABLE `wf_copy`
MODIFY COLUMN `originator_id` varchar(64) NULL DEFAULT NULL COMMENT '发起人主键' AFTER `user_id`;

ALTER TABLE sys_dept
ADD COLUMN oort_udid VARCHAR(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT 'UUID',
ADD COLUMN oort_dcode VARCHAR(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '部门code',
ADD COLUMN oort_pdcode VARCHAR(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '父部门code';

ALTER TABLE sys_menu
ADD COLUMN oort_pdcode varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '父菜单code';

ALTER TABLE sys_user
ADD COLUMN `oort_uuid` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '用户UUid',
ADD COLUMN `oort_udid` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '部门UUID',
ADD COLUMN `oort_ispart` char(1) NULL COMMENT '职位类型（1:兼职 0:正职）' AFTER `oort_udid`,
ADD COLUMN `oort_jobname` varchar(36) NULL COMMENT '职位名称' AFTER `oort_ispart`,
ADD COLUMN `dept_info` varchar(2000) NULL COMMENT '部门信息' AFTER `oort_jobname`;
