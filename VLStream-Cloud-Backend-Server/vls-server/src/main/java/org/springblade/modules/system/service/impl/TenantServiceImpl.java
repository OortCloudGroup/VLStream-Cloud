...
public class TenantServiceImpl extends BaseServiceImpl<TenantMapper, Tenant> implements ITenantService {
	...
	public boolean saveTenant(Tenant tenant) {
		if (Func.isEmpty(tenant.getId())) {
			...
			// Create default roles corresponding to the tenant
			Role role = new Role();
			...
			// Create default departments corresponding to the tenant
			Dept dept = new Dept();
			...
			// Create default positions corresponding to the tenant
			Post post = new Post();
			...
			// Create default admin user corresponding to the tenant
			User user = new User();
