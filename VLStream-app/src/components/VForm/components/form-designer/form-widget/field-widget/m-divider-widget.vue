<template>
  ...
  >
    <van-divider ref="fieldEditor" :style="{ borderColor: '#33333350' }" :dashed="field.options.dashed" :content-position="field.options.contentPosition">
      {{ field.options.label }}
    </van-divider>
  </static-content-wrapper>
</template>
...
export default {
  ...
  name: 'MDividerWidget', // 必须固定为FieldWidget，用于接收父级组件的broadcast事件
  components: {
