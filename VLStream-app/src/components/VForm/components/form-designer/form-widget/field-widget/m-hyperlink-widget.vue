<template>
  ...
  >
    ...
    >
      <template #input>
        <a v-if="field.options.hypeLinkOptions.linkType === 'success'" style="color: green" :href="field.options.hypeLinkOptions.linkUrl">
          {{ field.options.hypeLinkOptions.linkText }}
        </a>
        <a v-if="field.options.hypeLinkOptions.linkType === 'danger'" style="color: red" :href="field.options.hypeLinkOptions.linkUrl">
          {{ field.options.hypeLinkOptions.linkText }}
        </a>
        <a v-if="field.options.hypeLinkOptions.linkType === 'primary'" style="color: rgb(5, 101, 165)" :href="field.options.hypeLinkOptions.linkUrl">
          {{ field.options.hypeLinkOptions.linkText }}
        </a>
        <a v-if="field.options.hypeLinkOptions.linkType === 'info'" :href="field.options.hypeLinkOptions.linkUrl">
          {{ field.options.hypeLinkOptions.linkText }}
        </a>
      </template>
    </van-field>
