 ...
 * 智能分析查询
 */
export function getVlsAnalysisk(data) {
  return commonFunc('/vlsAnalysisRequest/list', data, 'GET')
}

/**
 * 智能分析保存
 */
export function saveVlsAnalysisk(data) {
  return commonFunc('/vlsAnalysisRequest/save', data, 'POST')
}

/**
 * 智能分析取消
 */
export function cancelVlsAnalysisk(data) {
  return commonFunc('/vlsAnalysisRequest/cancel', data, 'GET')
}
