...
页面顶部提供可收起的“使用流程”：创建项目 → 导入数据 → 质量筛选 → 数据标注 → 数据集与版本，
说明各阶段的操作与产出。下方蓝色文字为快捷入口，依次打开新建项目/当前项目设置、导入弹窗、
待审核样本列表、当前项目标注页和数据集版本页。尚未选择项目时，后四项先弹出可搜索、分页的项目选择，
选中后直接进入目标功能；切换到质量或版本页后自动滚动至操作区域。快捷导航不修改业务数据或触发训练。
